                ...
                <Card key={todo.id} className="mb-3">
                  <Card.Body>
                    <div>
                      ...
                      <Button variant="outline-danger" className="me-2" onClick={() => deleteUser(todo.class_id)}>
                        Delete
                      </Button>
                    
                    <Link to="/faculty/updateclass" state={
                      {currentClass:todo}
                      }>
                    ...
                    <Button variant="outline-info" onClick={refresh}>More Details</Button>
                  </Card.Body>
                </Card>
              );
            })}
