...
urlpatterns = [
    ...
    path('update/classes/<int:class_id>/', views.ClassesRetrieveUpdateAPIView.as_view(), name="classes_update"),
    path('delete/classes/<int:class_id>/', views.ClassesDestroyAPIView.as_view(), name="classes_delete"),
